...
public class SecurityUtils {
    ...
    public static class AES {
        ...
        private static final String VIPARA = "1234567890123456";
    ...
    public static void main(String args[])throws Exception {
        ...
        System.out.println(RC4.decrypt(aa));


        org.apache.commons.codec.binary.Base64.encodeBase64String(new String("1234567890123456" + AES.decrypt("helloworld"+"12345678901234561234567890123456")).getBytes());
    }
}
